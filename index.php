...
<html lang="en">
  ...
  <body>
    ...
    <form action="data.php" method="post" autocomplete="off">
        ...
        <button class="btn btn-success add"> Add To ToDo'S</button>
        ...
        if($result){
            while($row=mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td>
                    <a class="btn btn-success btn-sm edit" href="edit.php?id=<?php echo $id ?>" role="button">Edit</a>
                    <a class="btn btn-danger btn-sm delete" href="delete.php?id=<?php echo $id ?>" role="button">Delete</a>
